    ...
    <v-container  grid-list-md>
        <v-layout justify-center>
            <v-flex md12 class="text-md-center pt-3 pb-3">
                <v-card>
                <h1 class="headline">Vous êtes un professionnel de l'immobilier ?</h1>
                <v-btn id="addAdvert" class="subheading text-none" round outline large color="#00e094" dark @click="goToAddAdvertPage()">Déposer une annonce</v-btn>
                </v-card>
            </v-flex>
        </v-layout>
        <v-layout align-center justify-center row wrap>
            <v-flex md4>
                <v-card class="pb-4">
                    ...
                    <v-card-actions class="justify-center">
                        <v-btn href="/annonces/add/vente" id="addAdvert" class="subheading text-none" round large color="#00e094" dark @click="goToAddAdvertPage()">Mettre mon bien en vente</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
            <v-flex md4>
            ...
            <v-flex md4>
                <v-card class="pb-4">
                    <v-card-title class="justify-center pb-0">
                        <h2 class="secondary-color text-md-center headline font-weight-black mt-3"><img src="{{ asset('img/icons/search.png') }}" width="36px"/><br>Rechercher</h2>
                    </v-card-title>
                    <v-card-title class="justify-center pt-0">
                        <h3 class="title">Service gratuit</h3>
                    </v-card-title>
                    ...
                    <v-card-actions class="justify-center">
                        <v-btn href="/annonces/add/achat" id="addAdvert" class="subheading text-none" round large color="#2196F3" dark @click="goToAddAdvertPage()">Mettre ma recherche en ligne</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
        </v-layout>
