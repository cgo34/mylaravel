<template>
    <div v-if="page === 'myfavorites'">
        <v-flex xs12 sm12 md12>
            <v-layout align-center class="programme-card" @click.stop="showLots = !showLots">
                ...
                <v-flex xs12 sm12 md2 class="text-md-center">
                    ...
                    <div>
                        ...
                        <v-btn v-if="page === 'myfavorites'" round  color="#00e094" class="btn-box-shadow-primary font-weight-bold" depressed dark @click.stop="showLots = !showLots">{{ count }} lots <v-icon>expand_more</v-icon></v-btn>
                        <v-btn v-else round  color="#00e094" class="btn-box-shadow-primary font-weight-bold" dark depressed @click.stop="showLots = !showLots">{{ count }} lots <v-icon>expand_more</v-icon></v-btn>
                        <programme-lots
                            :userdata="user"
                            :idProgramme="id"
                            :nameProgramme="name"
